...
thisDir=os.path.dirname(__file__) #可识别相对路径
...
class SLMlogin:
    ...
    def driverSet(self):
        ...
        service = ChromeService(executable_path=os.path.join(thisDir,'chromedriver.exe'))
...
class HeaderResolve:
    ...
    def localFileHandle(self,mode,loginInfo=''):
        ...
        if mode=='read':
            ...
            print('新的token+cookie已写入本地文件%s' % self.localPath)
